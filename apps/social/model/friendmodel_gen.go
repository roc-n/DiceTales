...
func (m *defaultFriendModel) Insert(ctx context.Context, data *Friend) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Uid, data.FriendUid, data.Remark, data.AddSource)
	}, friendIdKey)
	return ret, err
}
...
func (m *defaultFriendModel) Update(ctx context.Context, data *Friend) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Uid, data.FriendUid, data.Remark, data.AddSource, data.Id)
	}, friendIdKey)
	return err
}
