...
type UserEntity struct {
	...
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`            // 用户自增id
	...
	Account       string                 `protobuf:"bytes,9,opt,name=account,proto3" json:"account,omitempty"`   // 用户账号
...
func (x *UserEntity) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	...
	"\x03sex\x18\b \x01(\x05R\x03sex\x12\x18\n" +
	"\aaccount\x18\t \x01(\tR\aaccount\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	...
	"\x03bio\x18\a \x01(\tR\x03bio\"\xf6\x01\n" +
	...
	"\rrefreshExpire\x18\a \x01(\x03R\rrefreshExpire\x12\x0e\n" +
	"\x02id\x18\b \x01(\x03R\x02id\"*\n" +
	"\x0eGetUserInfoReq\x12\x18\n" +
	"\aaccount\x18\x01 \x01(\tR\aaccount\"7\n" +
	"\x0fGetUserInfoResp\x12$\n" +
	"\x04user\x18\x01 \x01(\v2\x10.user.UserEntityR\x04user\"Q\n" +
	"\vFindUserReq\x12\x18\n" +
